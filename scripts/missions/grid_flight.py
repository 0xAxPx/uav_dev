...
def main():
    ...
    print_timestamped("  - Grid pattern: {len(waypoints)}")
    ...
    try:
        # 4. Start setpoint thread at ground level
        ...
        # 6. OFFBOARD mode with verification
        ...
        for i, waypoint in enumerate(mission):
            x, y, z = waypoint  # Even cleaner unpacking
